...
import com.photo.server.starsnap.exception.snap.error.exception.NotFoundTagException
...
class TagUseCaseImpl(
    ...
    override fun getTag(tag: String): Tag {
        val tag = tagRepositoryImpl.findByName(tag) ?: throw NotFoundTagException
        tag.count += 1
        return tagRepositoryImpl.save(tag)
    }
}