...
fun StarGroupEntity.toDto(): StarGroupResponseDto {
    return StarGroupResponseDto(
        name = this.name ?: throw RuntimeException("name는 null일 수 없습니다"),
        debutDate = this.debutDate ?: throw RuntimeException("debutDate는 null일 수 없습니다"),
        explanation = this.explanation,
        starGroupType = this.starGroupType ?: throw RuntimeException("starGroupType는 null일 수 없습니다")
    )
}
